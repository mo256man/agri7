...
class Contec():
    ...
    def input(self):
        ...
        if ret == cdio.DIO_ERR_SUCCESS:
            ...
            print(f"DioInpByte = {ret}: {err_str.value.decode('utf-8')}")
            return []
    ...
    def output(self, bool):
        ...
        if ret == cdio.DIO_ERR_SUCCESS:
            ...
            cdio.DioGetErrorString(ret, err_str)
            print(f"DioOutByte = {ret}: {err_str.value.decode('utf-8')}")
